...
void InitEntities(game_state *GameState)
{
    ...
    GameState->Entities[1].Stats.HP_Max = 20;
    GameState->Entities[1].Stats.HP_Now = 20;
    GameState->Entities[1].Stats.MP_Max = 5;
    GameState->Entities[1].Stats.MP_Now = 5;
    ...
    GameState->Entities[2].Stats.HP_Max = 30;
    GameState->Entities[2].Stats.HP_Now = 30;
    GameState->Entities[2].Stats.MP_Max = 5;
    GameState->Entities[2].Stats.MP_Now = 5;
    ...
    GameState->Entities[3].Stats.HP_Max = 25;
    GameState->Entities[3].Stats.HP_Now = 25;
    GameState->Entities[3].Stats.MP_Max = 5;
    GameState->Entities[3].Stats.MP_Now = 5;
